...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">服务修改</h3>
      </div>
    </div>
    ...
    <form action="${ctx}/RoomSet/update.do" method="post" onsubmit="return verify()">
	   <input type="hidden" name="id" value="${listPo.id}">
	    <div class="span12 margin-top-two">
	      <div class="row-fluid">
			  ...
			  <div class="span5 ">
			   	  <label class="labelroomnumber marginrightone">状态：</label>
	    ...
	    <div class="span12 margin-top-one">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber marginrighttwo">技师数：</label>
			  ...
			  <div class="span5">
			   	  <label class="labelroomnumber">服务等级：</label>
	    ...
	    <div class="span12 margin-top-one" >
	      <div class="row-fluid">
		       ...
		       <div class="span6">
			   	  <label class="labelroomnumber">标准价/天：</label>
	   ...
	   <div class="span9 margin-top-one">
	    ...
	    <div class="span12 margin-top-two">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber" style="margin-right:5px;">标准价/小时：</label>
			      <div class="input-prepend"  style="float:left;">
			        <span class="add-on" style="margin-top: 12px; height: 16px;">&yen;</span>
			      </div>
