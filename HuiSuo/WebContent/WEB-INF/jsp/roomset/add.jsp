...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">服务新增</h3>
      </div>
    </div>
    ...
    <form action="${ctx}/RoomSet/add.do" method="post" onsubmit="return verify()">
	    ...
	    <div class="span12 margin-top-one">
	      <div class="row-fluid">
		      <div class="span5">
			   	  <label class="labelroomnumber marginrighttwo">技师人数：</label>
	    ...
	    <div class="span12 margin-top-one" >
	      <div class="row-fluid">
		       ...
		       <div class="span6">
			   	  <label class="labelroomnumber">标准价格：</label>
