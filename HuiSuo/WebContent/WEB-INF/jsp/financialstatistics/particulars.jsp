...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">项目信息详情</h3>
    ...
    <form action="${ctx}/StayRegister/add.do" method="post" onsubmit="return verify()">
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		     ...
		     <div class="span4">
		        <label class="floatont">服务等级：</label>
	    ...
	    <div class="span12">
	      <div class="row-fluid">
	         <div class="span4">
		        <label class="floatont">顾客姓名：</label>
		        <label class="yanseblue">${list[0].passengerName}</label>
		     </div>
		     <div class="span4">
		        <label class="floatont">顾客性别：</label>
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		     ...
		     <div class="span4">
		        <label class="floatont">顾客电话：</label>
		        <label class="yanseblue">${list[0].pssengerContactPhoneNumber}</label>
		     </div>
		     <div class="span4">
		        <label class="floatont">顾客类别：</label>
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span4">
		        <label class="floatont">顾客级别：</label>
	   ...
	   <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
	    <div class="span12">
	      <div class="row-fluid">
		     <div class="span4">
		        <label class="floatont">价格/天：</label>
		        <label class="yanseblue">${list[0].roomStandardPriceDay}</label>
		     </div>
		     <div class="span4">
		        <label class="floatont">价格/小时：</label>
	    ...
	    <div class="span12">
	      <div class="row-fluid">
		     ...
		     <div class="span4">
		        <label class="floatont">服务费：</label>
		        <label class="yanseblue">${zhuSuFei}</label>
		     </div>
		     <div class="span3">
		        <label class="floatont">商品费：</label>
