...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">安排服务</h3>
    ...
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
      ...
      <div class="span12">
	   ...
	   <div class="span12" style="margin-top:-17px;">
        <div class="row-fluid">
          <button class="btn btn-info btn-small" type="button" onclick="allroomfunction()">所有服务</button>
          <button class="btn btn-info btn-small" type="button" onclick="onefunction()">胃肠保养</button>
          <button class="btn btn-info btn-small" type="button" onclick="twofunction()">脊柱保养</button>
          <button class="btn btn-info btn-small" type="button" onclick="threefunction()">精油按摩</button>
          <button class="btn btn-info btn-small" type="button" onclick="fourfunction()">拔火罐</button>
          <button class="btn btn-info btn-small" type="button" onclick="fivefunction()">颅内净化减压</button>
          <button class="btn btn-info btn-small" type="button" onclick="sixfunction()">全身芳香理疗</button>
          <button class="btn btn-info btn-small" type="button" onclick="sevenfunction()">十二经络平衡术</button>
        </div>
       </div>
