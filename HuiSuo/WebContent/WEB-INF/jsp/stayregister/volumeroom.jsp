...
<!--   <link rel="stylesheet" href="${ctx}/css/roomset/roomset.css" type="text/css"></link> -->
  ...
  <div class="container" style="height:630px;overflow-x:auto;">
    ...
    <div class="span9 margin-top-one">
      <div class="row-fluid">
        <h3 style="text-align: center;">批量安排服务</h3>
    ...
    <!--  ———————————————————————————————————————————————————————————————————————————————————————— -->
      ...
      <div class="span12">
	      <fieldset>
	        <legend>
	                       状态：<button href="#xuanzhe" data-toggle="modal" class="btn btn-info btn-small" onclick="selectRoom()"><li class="icon-plus icon-white"></li>选择房间</button>
	                       </legend>
	      </fieldset>
	  </div>
       ...
       <table class="table table-condensed table-bordered table-striped" id="tableid">
	      <thead class="theadone">
	        <tr>
	          ...
	          <th rowspan="2">技师数</th>
	          <th rowspan="2">标准服务/天</th>
	          <th colspan="4">钟点服务设置</th>
